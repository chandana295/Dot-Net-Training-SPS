/*
Deployment script for SPSTechnologyDB
...
GO
:setvar DatabaseName "SPSTechnologyDB"
:setvar DefaultFilePrefix "SPSTechnologyDB"
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Technology'))
               AND [type] IN (N'F', N'C')
